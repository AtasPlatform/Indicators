namespace ATAS.Indicators.Technical
{
	...
	public class OSMA : Indicator
	{
        ...
        [Parameter]
        [Display(ResourceType = typeof(Strings), Name = "ShortPeriod", GroupName = "Period", Order = 100)]
		[Range(2, 10000)]
        ...
        [Parameter]
        [Display(ResourceType = typeof(Strings), Name = "LongPeriod", GroupName = "Period", Order = 110)]
		[Range(2, 10000)]
        ...
        [Parameter]
        [Display(ResourceType = typeof(Strings), Name = "SignalPeriod", GroupName = "Period", Order = 120)]
		[Range(2, 10000)]
