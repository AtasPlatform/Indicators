namespace ATAS.Indicators.Technical
{
	...
	public class OrderFlow : Indicator
	{
		...
		[Display(ResourceType = typeof(Strings), Name = "Trades", GroupName = "Mode", Order = 100)]
        ...
        [Display(ResourceType = typeof(Strings), Name = "Font", GroupName = "Visualization", Order = 130)]
		public FontSetting Font { get; set; } = new("Arial", 10);

		[Display(ResourceType = typeof(Strings), Name = "TextColor", GroupName = "Visualization", Order = 135)]
