...
public class DOM : Indicator
{
	...
	public enum Mode
	{
		[Display(ResourceType = typeof(Strings), Name = "Levels")]
		Common,

		[Display(ResourceType = typeof(Strings), Name = "Cumulative")]
		Cumulative,

		[Display(ResourceType = typeof(Strings), Name = "Both")]
		Combined
	}
	...
	[Display(ResourceType = typeof(Strings), Name = "VisualMode", GroupName = "HistogramSize", Order = 100)]
	...
	[Display(ResourceType = typeof(Strings), Name = "UseAutoSize", GroupName = "HistogramSize", Order = 105)]
	...
	[Display(ResourceType = typeof(Strings), Name = "BidRows", GroupName = "LevelsMode", Order = 200)]
	...
	[Display(ResourceType = typeof(Strings), Name = "TextColor", GroupName = "LevelsMode", Order = 210)]
	...
	[Display(ResourceType = typeof(Strings), Name = "AskRows", GroupName = "LevelsMode", Order = 220)]
	...
	[Display(ResourceType = typeof(Strings), Name = "BidsBackGround", GroupName = "LevelsMode", Order = 230)]
	...
	[Display(ResourceType = typeof(Strings), Name = "AsksBackGround", GroupName = "LevelsMode", Order = 240)]
	...
	[Display(ResourceType = typeof(Strings), Name = "BestBidBackGround", GroupName = "LevelsMode", Order = 250)]
	...
	[Display(ResourceType = typeof(Strings), Name = "BestAskBackGround", GroupName = "LevelsMode", Order = 260)]
	...
	[Display(ResourceType = typeof(Strings), Name = "Filters", GroupName = "LevelsMode", Order = 270)]
	[JsonProperty(ObjectCreationHandling = ObjectCreationHandling.Reuse)]
	public ObservableCollection<FilterColor> FilterColors { get; set; } = new();

	[Display(ResourceType = typeof(Strings), Name = "AskColor", GroupName = "CumulativeMode", Order = 280)]
	public Color CumulativeAskColor { get; set; } = Color.FromArgb(255, 100, 100);

	[Display(ResourceType = typeof(Strings), Name = "BidColor", GroupName = "CumulativeMode", Order = 285)]
