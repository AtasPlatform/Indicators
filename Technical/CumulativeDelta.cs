...
public class CumulativeDelta : Indicator
{
    ...
    public enum SessionMode
    {
        ...
        [Display(ResourceType = typeof(Strings), Name = "Default")]
        DefaultSession,
    ...
    [Display(ResourceType = typeof(Strings), Name = "VisualMode", GroupName = "Settings", Order = 10)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "SessionDeltaMode", GroupName = "Settings", Order = 20)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "CustomSessionStart", GroupName = "Settings", Order = 25)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "UseScale", GroupName = "Settings", Order = 30)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "UseAlerts", GroupName = "Alerts", Order = 110)]
    public bool UseAlerts { get; set; }

    [Display(ResourceType = typeof(Strings), Name = "AlertFile", GroupName = "Alerts", Order = 120)]
    public string AlertFile { get; set; } = "alert1";

    [Display(ResourceType = typeof(Strings), Name = "RequiredChange", GroupName = "Alerts", Order = 130)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "FontColor", GroupName = "Alerts", Order = 140)]
    public Color AlertForeColor { get; set; } = Color.FromArgb(255, 247, 249, 249);

    [Display(ResourceType = typeof(Strings), Name = "BackGround", GroupName = "Alerts", Order = 150)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "Positive", GroupName = "Drawing", Order = 210)]
    ...
    [Display(ResourceType = typeof(Strings), Name = "Negative", GroupName = "Drawing", Order = 220)]
